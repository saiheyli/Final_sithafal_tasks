...
st.markdown("Upload a PDF file and ask questions about its content. This app will use a language model to answer your queries.")

local_path = st.file_uploader("Upload your PDF file", type=["pdf"])
...
if local_path:
    ...
    try:
        data = loader.load()
        st.success(f"PDF loaded successfully: {local_path.name}")
